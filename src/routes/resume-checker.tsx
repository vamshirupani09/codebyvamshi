...
export const Route = createFileRoute("/resume-checker")({
  head: () => seoHead({ path: "/resume-checker", title: "AI Resume Score Checker (ATS) | Codex", description: "Upload your resume and get an ATS-style score, keyword gaps, section feedback and STAR-format rewrites generated by AI in seconds.", ogTitle: "AI Resume Score Checker (ATS) | Codex", ogDescription: "Get an ATS score, keyword gaps and AI rewrites for your resume in seconds." }),
  component: () => (
    <DashboardLayout>
      <ResumeChecker />
    </DashboardLayout>
