...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Practice DSA, run code, and ship projects with a multi-agent AI coding assistant." },
      { name: "author", content: "Codex" },
      { property: "og:title", content: "Codex — Multi-Agent AI Coding Assistant" },
      { property: "og:description", content: "Practice DSA, run code, and ship projects with a multi-agent AI coding assistant." },
